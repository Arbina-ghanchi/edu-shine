  ...
  const contactMethods = [
    {
      ...
      detail: "+91 7990769647,+91 9427392612, +91 8780969747",
      icon: Phone,
      action: "tel:+91 7990769647, +91 9427392612, +91 8780969747",
    ...
    },
    {
      ...
      detail: "edushinestudyhub2all@gmail.com",
      icon: Mail,
      action: "mailto:edushinestudyhub2all@gmail.com",
    ...
    },
    {
      ...
      detail: "Divine Galaxy Duplex, 55, near Chanakya Nagari, Kalali, Vadodara, Gujarat 390012",
      icon: MapPin,
      action: "#",
          ...
          >
            {contactMethods.map((method, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${method.color} opacity-0 group-hover:opacity-100 transition-all duration-500`}
                  ></div>
            ...
            {[
              {
                ...
                desc: "Get a response in minutes",
              },
              {
                icon: Phone,
                title: "24/7 Support",
              ...
              },
              {
                ...
                desc: "Professional educational advice",
              },
              {
                icon: BookOpen,
                title: "Free Consultation",
                desc: "Initial assessment at no cost",
              },
            ].map((item, index) => {
